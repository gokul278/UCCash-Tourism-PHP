    ...
    success: function (res) {
      ...
      if (response.status == "success") {
        if (response.action == "nopay") {
          $("#pagecontent").html(
            "<div class='container' algin='center'><h5 style='color:red'>Waiting for pending Approval</h5></div>"
          );
          ...
          $("#pagecontent").html(
            "<div class='container' algin='center'><h5 style='color:red'>Already ID Activated</h5></div>"
          );
          $(".toggle-button-container").html("");
        }
