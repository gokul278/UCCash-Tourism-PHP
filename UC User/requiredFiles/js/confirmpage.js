...
const checkpaymenttype = () => {
  ...
  if (paymenttype === "none") {
    ...
    $("#paymentinput").html(
      '<input class="form-control" id="savingstravelpoints" type="number" placeholder="Enter the Savings Travel Point" oninput="checksavingstp()" style="height: 50px;">'
    );
    ...
    $("#paymentinput").html(
      '<input class="form-control" id="travelcoupon" type="number" placeholder="Enter the Travel Coupon\'s" oninput="checktravelcoupon()" style="height: 50px;">'
    );
...
$("#otpbtn").click(function (e) {
  ...
  if (paymenttype === "none") {
    ...
    if (
      savingstravelpoints.length >= 1 ||
      bonustravelpoints.length >= 1 ||
      travelcoupon.length >= 1
    ) {
      $("#paymenttype").prop("disabled", true);
      $("#bonustravelpoints").prop("disabled", true);
      $("#savingstravelpoints").prop("disabled", true);
