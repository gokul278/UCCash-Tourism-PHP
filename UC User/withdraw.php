         ...
         <div class="sidebar pe-4 pb-3">
            <nav  class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="withdraw.php" class="nav-item nav-link active"><i class="fa fa-university me-2"></i>Withdraw</a>
                    <div class="nav-item dropdown">
...
@keyframes runningBalance {
    ...
    .running-balance {
        color: #f7c128;
        animation: runningBalance 2s infinite; /* Adjust the animation duration as needed */
    }
                ...
                <div class="row g-4">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <strong> <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        <form>
                                            <div class="mb-3">
                                                <label for="cryptoType" class="form-label">Crypto Type:</label>
                                                <select class="form-select" id="cryptoType" required>
                                                    <option value="" disabled selected>Select Crypto Type</option>
                                                    <option value="bitcoin">USDT (TRC20)</option>
                                                    <option value="ethereum">UCC ( BEP20)</option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="walletAddress" placeholder="Enter your crypto wallet address" required>
                                            </div>
                                    
                                            <div class="mb-3">
                                                <label for="WithdrawAmount" class="form-label">Withdraw Amount:</label>
                                                <input type="number" class="form-control" id="WithdrawAmount" placeholder="Enter your Withdraw amount" required>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <form>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="bankName" placeholder="Enter the name of your bank" required>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="accountNumber" placeholder="Enter the account number" required>
                                            </div>

                                            <div class="mb-3">
                                                <label for="IFSC" class="form-label">IFSC:</label>
                                                <input type="text" class="form-control" id="branch" placeholder="Enter the IFSC code" required>
                                            </div>
                                    
                                            <div class="mb-3">
                                                <label for="branch" class="form-label">Branch:</label>
                                                <input type="text" class="form-control" id="branch" placeholder="Enter the branch name" required>
                                            </div>
