        ...
        <div class="sidebar pe-4 pb-3">
            <nav  class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="booking history.php" class="nav-item nav-link active"><i class="fa fa-bookmark me-2"></i>Booking History</a>
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true">Tour</button>
                                </li>
                                <!-- <li class="nav-item" role="presentation">
                                    ...
                                    <div class="container">
                                        <div class="card">
                                            <div style="text-align: center;">
                                                <h4>Taj Mahal</h4>
                                                <img src="img/taj mahal.jpg" alt="Tour Img" width="290" height="300" />
                                                <p></p>
                                                <p style="color: #000;">Date: March 10, 2024</p>
                                                <p style="color: #000;">Place: Your Location</p>
                                                <p style="color: #000;">
                                                    <i class="fa fa-users" aria-hidden="true"></i> : 2 Passengers
                                                    &nbsp;&nbsp; 
                                                    <i class="fa fa-id-card" aria-hidden="true"></i> ID : UCT123456
                                                </p>
                                                <strong><hr style="border-top: 3px solid #000; font-weight: bold;"></strong>
                                                <div style="text-align: center;">
                                ...
                                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                    <div class="soon py-5">
                                        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                                            <h1 class="mb-0">COMING <span style="color: #f7c128;">SOON</span></h1>
                                            <br>
                                            <h5 style="color: #000;"><strong><a href="https://uccashtourism.com" target="_blank" >www.uccashtourism.com</strong></a></h5>
                                        </div>
                                    </div>
                                </div>
