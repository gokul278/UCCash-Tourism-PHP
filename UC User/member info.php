                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="member info.php" class="dropdown-item active">Member Info</a>
...
<div class="container-xl px-4 mt-4">
    <div class="row">
       <div class="col-xl-8">
          <div class="card mb-4">
             <div class="card-header"><b>Member Info</b></div>
             <div class="card-body">
                <form>
                    <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                           <label class="small mb-1" for="Sponser name">Sponser Name</label>
                           <input class="form-control" id="Sponsername" type="text" placeholder="Sponser Name" disabled>
                        </div>
                        <div class="col-md-6">
                           <label class="small mb-1" for="User Name">User Name</label>
                           <input class="form-control" id="username" type="text" placeholder="User Name" disabled>
                        </div>
                     </div>
                     ...
                     <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                           ...
                           <input class="form-control" id="Phone" type="tel" placeholder="Enter your phone number" disabled>
                        </div>
                        <div class="col-md-6">
                            <label class="small mb-1" for="inputEmailAddress">Email address</label>
                            <input class="form-control" id="inputEmailAddress" type="email" placeholder="Enter your email address" disabled>
                        </div>
                     </div>

                     <!-- <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                           <label class="small mb-1" for="Aadhar Number">Aadhar Number</label>
                           <input class="form-control" id="Aadhar" type="tel">
                        </div>
                        <div class="col-md-6">
                           <label class="small mb-1" for="Pancard">Pancard</label>
                           <input class="form-control" id="Pancard" type="text">
                        </div>
                     </div> -->
...
<!--OTP End-->
 ...
 <script type="text/javascript"></script>
    ...
    <script src="./requiredFiles/js/memberinfo.js"></script>
</body>
