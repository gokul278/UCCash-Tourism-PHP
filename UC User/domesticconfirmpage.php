...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="domestictourbooking.php" class="dropdown-item active">Domestic Booking</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
        ...
        <div class="content">
                    ...
                    <div class="amnt">
                        ...
                        <table>
                            <tbody style="font-size: 17px;font-weight:700">
                                ...
                                <tr>
                                    <td colspan="2" style="width:100%;padding:10px;font-size:15px;font-weight:500;background:#f7c128;color:#000;border-radius:10px" align="left">Note: Discount is applicable only for users with Distributor rank.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                ...
                                <div class="bg-light rounded h-100 p-4">
                                    <div class="form-floating d-flex justify-content-center">
                                        <select class="form-select" id="paymenttype"
                                            ...
                                            <option value="allpoints">Top-up Wallet + Bonus Travel Points</option>
                                        </select>
            ...
            <script src="./requiredFiles/js/domesticconfirmpage.js"></script>
