        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="referral.html" class="nav-item nav-link"><i class="fa fa-user-plus me-2"></i>Refferal
                        Link</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                    ...
                    <a href="distributor activation status.html" class="nav-item nav-link"><i
                    ...
                    <a href="coupon usage history.html" class="nav-item nav-link"><i class="fa fa-gift me-2"></i>Travel
                    ...
                    <a href="monthly TP savings status.html" class="nav-item nav-link"><i
                            class="fa fa-donate me-2"></i>Monthly TP <p style="text-align: center;">Saving History</p>
                        </a>
                    <a href="monthly savings pending invoice.html" class="nav-item nav-link"><i
                    ...
                    <a href="booking history.html" class="nav-item nav-link"><i class="fa fa-bookmark me-2"></i>Booking
                        History</a>
            ...
            <div class="container">
                <div class="d-flex justify-content-center">
                    <div class="description-box">
                        ...
                        <br>
                        <h6 style="text-align: justify; margin-bottom: 20px;">1) Capture the essence of the tour in an
                            engaging opening sentence.</h6>
                        <h6 style="text-align: justify; margin-bottom: 20px;">2) Showcase the most exciting attractions
                            or experiences participants will encounter.</h6>
                        <h6 style="text-align: justify; margin-bottom: 20px;">3) Provide a clear breakdown of the tour's
                            schedule and activities.</h6>
                        <h6 style="text-align: justify; margin-bottom: 20px;">4) Clearly state what's included in the
                            package and what's not.</h6>
                        <h6 style="text-align: justify; margin-bottom: 20px;">5) Encourage readers to book their spot
                            with a compelling closing statement.</h6>
                        <div style="text-align: center; margin-top: 20px;">
                            <a href="confirm page.html">
                                <button
                                    style="background-color: #f7c128; color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; animation: pulse 1.5s infinite;">Book
                                    Now</button>
                            </a>
                        </div>
