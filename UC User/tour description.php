                ...
                <div class="container">
                    <div class="d-flex flex-column align-items-center">
                        <div class="d-flex justify-content-center">
                            <div class="image-box">
                                ...
                                <div class="white-container">
                                    <img id="displayedImage" src="./img/family package.jpg" alt="Description Image" class="centered-image">
                                </div>
                        ...
                        <div class="thumbnail-container">
                            <img src="./img/honeymoon package.jpg" alt="Thumbnail 1" class="thumbnail-image" data-index="0">
                            <img src="./img/taj mahal.jpg" alt="Thumbnail 2" class="thumbnail-image" data-index="1">
                            <img src="./img/manarola1.png" alt="Thumbnail 3" class="thumbnail-image" data-index="2">
                            <img src="./img/tour.jpg" alt="Thumbnail 4" class="thumbnail-image" data-index="3">
                            <img src="./img/family package.jpg" alt="Thumbnail 5" class="thumbnail-image" data-index="4">
                            <img src="./img/tour1.jpg" alt="Thumbnail 6" class="thumbnail-image" data-index="5">
                        </div>
                    </div>
                    ...
                    .white-container {
                        ...
                        width: 775px; /* Set the fixed width */
                    ...
                    .d-flex {
    display: flex;
    align-items: center; /* Align icons vertically with the image */
}
...
.nav-icon:hover {
    color: #444; /* Change color on hover if desired */
}
...
.thumbnail-image {
    ...
    height: 40px; /* Decrease thumbnail height */
    margin: 0 5px;
    cursor: pointer;
...
<div class="d-flex justify-content-center">
    <div class="description-box">
        <h1 style="text-align: center;">Thailand <span style="color: #f7c128;">Overview</span></h1>
        <br>
        <h6 style="text-align: center; margin-bottom: 20px;"><b>Booking Code : TRB001</b></h6>
        <h6 style="text-align: center; margin-bottom: 20px;"><b>Days : 4 Days / 3 Nights</b></h6>
        <h6 style="text-align: center; margin-bottom: 20px;"><b>From Date : 31/05/2024</b></h6>
        <h6 style="text-align: center; margin-bottom: 20px;"><b>To Date : 03/06/2024</b></h6>
        <h6 style="text-align: center; margin-bottom: 20px;"><b>Amount : 500 TP</b></h6>
    </div>
</div>
<br><br>
<div class="row">
    <div class="col-sm-12 col-xl-6 mx-auto">
        <div class="bg-light rounded h-100 p-4">
            <h1 class="mb-4"><span style="color: #f7c128; text-align: center;">Tajmahal</span> Itinerary</h1>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <h5 style="background-color:#f7c128; padding: 10px; font-size: large;">Day 1</h5><h6>&nbsp;&nbsp;&nbsp;&nbsp;Tajmahal</h6> 
                        </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse"
                        aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div style="text-align: justify;" class="accordion-body">
                            Arrivel to Agra check in hotel and Visit Evening Free To Stroll In The Famous Shopping Place Of 
                            Agra Town - The Mall & The Ridge. Later Back To Hotel. Overnight Stay At Hotel At Tajmahal.
                        </div>
                    </div>
                </div>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button"
                        ...
                        <h5 style="background-color:#f7c128; padding: 10px; font-size: large;">Day 2</h5><h6>&nbsp;&nbsp;&nbsp;&nbsp;Tajmahal</h6> 
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button"
                        ...
                        <h5 style="background-color:#f7c128; padding: 10px; font-size: large;">Day 3</h5><h6>&nbsp;&nbsp;&nbsp;&nbsp;Tajmahal</h6> 
                    </button>
                </h2>
...
<div style="text-align: center; margin-top: 20px;">
    <a href="confirm page.php">
        <button style="background-color: #f7c128; color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; animation: pulse 1.5s infinite;">Continue Booking</button>
    </a>
</div>
   ...
   <script>
    const images = [
        './img/honeymoon package.jpg',
        './img/taj mahal.jpg',
        './img/manarola1.png',
        './img/tour.jpg',
        './img/family package.jpg',
        './img/tour1.jpg'
    ];
