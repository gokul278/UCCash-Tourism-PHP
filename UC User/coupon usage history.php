         ...
         <div class="sidebar pe-4 pb-3">
            <nav  class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="coupon usage history.php" class="nav-item nav-link active"><i class="fa fa-gift me-2"></i>Travel Coupon <p style="text-align: center;">Usage History</p></a>
                            ...
                            <div class="table-responsive">
                               <strong><table style="color: black; text-align: center;" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td>02/02/2024 <p class="time">12:08 PM</p></td>
                                            <td>UCT123456</td>
                                        ...
                                        <tr>
                                            <th scope="row">2</th>
                                            <td>02/05/2024 <p class="time">10:50 AM</p></td>
                                            <td>UCT123456</td>
