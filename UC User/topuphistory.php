                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="distributor activation status.php" class="nav-item nav-link"><i
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="topuphistory.php" class="dropdown-item active">Topup Wallet History</a>
                        </div>
                    </div>
...
<a href="rewardbonus.php" class="dropdown-item">Reward Bonus</a>
                ...
                <div>
                    <form id="filterDate">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <input type="date" id="fromDate" name="fromDate" oninput="check()" class="form-control mr-2"
                                style="width: 120px;">
                            <label for="toDate" class="mr-2"><b style="color: #000;">To</b></label>
                            <input type="date" id="toDate" name="toDate" oninput="check()" class="form-control mr-2"
                                style="width: 120px;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Topup Wallet History</h6>
    ...
    <script src="./requiredFiles/js/topuphistory.js"></script>
</body>
