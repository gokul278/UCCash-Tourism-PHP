            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="topupdeposite.php" class="dropdown-item active">Topup Wallet Deposite</a>
        ...
        <div class="content">
            ...
            <div id="pagecontent" class="page-container">
                                    ...
                                    <div class="card-body">
                                        <strong>
                                            <form id="activationcrypto" style="color: #000;">
                                                ...
                                                <div class="row gx-3 mb-3 justify-content-center">
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="deposit value">Deposit
                                                            Value in Dollar Value</label>
                                                        <input class="form-control" name="cryptoDepositeVal" oninput="getCryptoDepositeVal()" id="crypto_deposit_value" type="number"
                                                ...
                                                <div class="row gx-3 mb-3 justify-content-center">
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="deposit value">Topup Wallet
                                                            Amount</label>
                                                        <input class="form-control" name="cryptoDepositeVal" id="crypto_topup_wallet" value="0" readonly type="number"
                                                            placeholder="Enter Deposit Value">
                                                    </div>
                                                </div>
                ...
                <div id="page2" class="page">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <form id="activationbank">
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0">Deposit Value in INR</h6>
                                                        </div>
                                                        <div class="col-sm-9 text-secondary">
                                                            <input type="number" name="depositevalue" class="form-control" oninput="getBankDepositeVal()" id="bank_deposit_value"></input>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0">Todays Rate</h6>
                                                        </div>
                                                        <div class="col-sm-9 text-secondary">
                                                            <span class="form-control" id="inrShow">0 USD = 0 INR</span>
                                                            <input type="hidden" id="inrval">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0">Topup Wallet Amount</h6>
                                                        </div>
                                                        <div class="col-sm-9 text-secondary">
                                                            <input class="form-control" id="bank_topup_wallet" value="0" readonly></input>
                                                        </div>
                                                    </div>
                                                    <br><br><br>
                    ...
                    <script src="./requiredFiles/js/topupdeposite.js"></script>
</body>
