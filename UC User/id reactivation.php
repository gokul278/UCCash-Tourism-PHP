                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="id reactivation.php" class="dropdown-item active">TP Reactivation</a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center mt-3"> <!-- Centering the row and adding margin-top -->
                    ...
                    <div class="col-sm-6 col-xl-4">
                        ...
                        <div class="card rounded bg-light text-center" style="margin-top: 80px;">
                            <!-- Adding margin-top -->
                            <img style="margin: auto; width: 80px; height: 80px;" src="img/id.png" class="card-img-top"
                                alt="Coupon Image">
                            <div class="card-body">
                                <h2 class="card-title mb-2">TP Reactivation Wallet</h2>
