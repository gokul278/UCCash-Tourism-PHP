                                ...
                                <form id="changespass">
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" onclick="clearmsg()" id="OldPassword"
                                                pattern='(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,}' name="oldpassword"
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="password" oninput="checkrepass()"
                                                pattern='(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,}' name="newpassword"
                                                type="password" required>
                                        </div>

                                    </div>
                                    <div style="font-size:15px;color:red" class="row gx-3 mb-3">
                                        <div id="uppercase"><span style="font-size:20px">*</span> A capital (UPPERCASE)
                                            Letter</div>
                                        <div id="lowercase"><span style="font-size:20px">*</span> A lowercase
                                            (LOWERCASE) letter</div>
                                        <div id="special"><span style="font-size:20px">*</span> A Special Character
                                        </div>
                                        <div id="min8"><span style="font-size:20px">*</span> Minimum 8 characters</div>
                                    </div>
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="Confirm New Password">Confirm New
                                                Password</label>
                                            <input class="form-control" id="repassword" oninput="checkrepass()"
                                                pattern='(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,}' type="password"
                                                required>
                                        </div>
                                    ...
                                    <div class="button-container">
                                        <button type="submit" id="submitbtn" class="btn btn-primary" disabled>Save
                                            Changes</button>
                                    </div>
