...
.mr-2 {
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Monthly Savings Pending Invoice</h6>
                                    ...
                                    <table style="color: black; text-align: center;" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Saving Value</th>
                                                <th scope="col">Bonus TP</th>
                                                <th scope="col">Total TP</th>
                                                <th scope="col">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody id="pendinginvoicetable">
                                        </tbody>
                                    </table>
                                </strong>
                            </div>
    ...
    <script src="./requiredFiles/js/monthlysavingspendinginvoice.js"></script>
</body>
