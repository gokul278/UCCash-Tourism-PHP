        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-id-card me-2"></i>TP Activation<p style="text-align: center;"> Deposit</p>
                        </a>
                        <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="distributor activation status.php" class="nav-item nav-link"><i class="fa fa-signal me-2"></i>TP Activation <p style="text-align: center;">History</p></a>
                    <div class="nav-item dropdown">
                                            ...
                                            <div class="card-body">
                                                <strong>
                                                    <form id="activationcrypto" style="color: #000;">
                                                        ...
                                                        <div class="text-center">
                                                            <button class="btn btn-primary" id="cryptoDepositeBtn" type="submit">Submit</button>
                                                        </div>
                                                    </form>
                                                </strong>
                                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <form id="activationbank">
                                                            ...
                                                            <div class="text-center">
                                                                <button class="btn btn-primary" id="bankDepositeBtn" type="submit">Submit</button>
                                                            </div>
                                                        </form>
