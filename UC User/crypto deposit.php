        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="supports.phps" class="nav-item nav-link"><i class="fa fa-comment me-2"></i>Supports</a>
                                ...
                                <strong>
                                    <form style="color: #000;">
                                        ...
                                        <div class="col-md-6 mx-auto text-center">
                                            <img src="img/Distributor Activation.jpg" alt="Profile Image"
                                            ...
                                            <div class="col-md-6 mx-auto">
                                                ...
                                                <div class="input-group">
                                                    <span class="form-control"
                                                        id="deposit address">TK8XreREARoQse2B9xPMidL7WWNVHZSb2c</span>
                                        ...
                                        <div class="row gx-3 mb-3 justify-content-center">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="deposit value" type="text"
                                                    placeholder="Enter Deposit Value" value="60">
                                            </div>
                                        </div>
