...
<head>
    ...
    overflow-x: auto;
      ...
      .genealogy-tree ul ul li:first-child {
          margin-left: 5px;
      }

      .genealogy-tree ul ul li:last-child {
          margin-right: 5px;
      }
...
/* Tooltip arrow */
.genealogy-tree a .tooltiptext::after {
    content: "";
    position: absolute;
    top: 100%;
    left: 50%;
...
.genealogy-tree a:hover .tooltiptext {
    visibility: visible;
    opacity: 1;
}
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
         ...
         <div class="sidebar pe-4 pb-3">
            <nav  class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-users me-2"></i>My Team</a>
                        <div class="dropdown-menu bg-transparent border-0">
        ...
        <div class="content">
            ...
            <div class="genealogy-tree">
                <ul>
                    <li>
                        <a href="#" class="hover-container" title="Name: Ashok Kumar V 
            Sponsor: UTC67890
            Registration Date: 01/01/2024
            Package: Activation Package
            Activation Date: 20/03/2024
            Investment Amount: $5000">
                            <img class="parentimg" src="img/ashok (2).jpg">
                            <div class="hover-box">
                                <p><b>Ashok Kumar</b></p>
                                <p>UCT123456</p>
                            </div>
                        ...
                        <ul>
                            <li>
                                <a href="member_acc.php" target="_blank" title="Click to Register : UCT123456">
