...
if (isset($_POST["certificateid"]) && strlen($_POST["certificateid"]) > 1) {
    ...
    if ($getdetails["deposite_type"] == 'Crypto') {
        ...
        $content = ' <tr>
            <td style="width:100%;font-size:14px;">
                <table style="width:99%">
                        ...
                        <tr align="center">
                            <td style="width:80%;color:#6F6F6F;border: 1px solid #6F6F6F;font-size:13px;">
                                <table style="margin: 0; padding: 0;">
                                    <tr>
                                        <td style="width:65%"></td>
                                        <td style="color:#6F6F6F;font-size:13px;"><b>GST ' . $gst . ':</b></td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width:20%;color:#6F6F6F;border: 1px solid #6F6F6F;font-size:13px;"><b>' . $gstAmount . '</b></td>
                        </tr>
                        <tr align="center">
                            <td style="width:80%;color:#6F6F6F;border: 1px solid #6F6F6F;font-size:13px;">
                                <table style="margin: 0; padding: 0;">
                                    <tr>
                                        <td style="width:65%"></td>
                                        <td style="color:#6F6F6F;font-size:13px;"><b>Total:</b></td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width:20%;color:#6F6F6F;border: 1px solid #6F6F6F;font-size:13px;"><b>' . $totalAmount . '</b></td>
                        </tr>
                </table>
            </td>
        </tr>';
        ...
        <td style="width:100%;font-size:14px;">
            <table style="width:99%">
                    <tr align="center">
                        <td style="background-color:#011B3B;color:white;font-size:10px;">Invoice No</td>
                        <td style="background-color:#011B3B;color:white">SAC</td>
                        <td style="background-color:#011B3B;color:white">Activation Date</td>
                        <td style="background-color:#011B3B;color:white">Travel Coupoon</td>
                        <td style="background-color:#011B3B;color:white">Activation Amount</td>
