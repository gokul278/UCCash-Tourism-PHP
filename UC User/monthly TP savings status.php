        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="monthly TP savings status.php" class="nav-item nav-link  active"><i
            ...
            <div class="container-fluid">
                <div>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <input type="date" id="fromDate" oninput="changeenable()" class="form-control mr-2"
                            style="width: 120px;">
                        <label for="toDate" class="mr-2"><b style="color: #000;">To</b></label>
                        <input type="date" id="toDate" oninput="changeenable()" class="form-control mr-2"
                            style="width: 120px;">
                        <button id="goButton" class="btn btn-primary" onclick="getbtn()"
                            disabled>Go</button>&nbsp;&nbsp;
