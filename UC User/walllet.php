                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="walllet.php" class="dropdown-item active">Wallet Address</a>
                ...
                <form id="walletaddress">
                    <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                           ...
                           <input class="form-control" id="trc20address" name="trc20_address" type="text" >
                        </div>
                     </div>
                     <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                           <label class="small mb-1" for="BEP20 Address">BEP20 Address</label>
                           <input class="form-control" id="bep20address" name="bep20_address" type="text">
