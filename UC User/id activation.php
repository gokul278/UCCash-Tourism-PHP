         ...
         <div class="sidebar pe-4 pb-3">
            <nav  class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-id-card me-2"></i>ID Activation<p style="text-align: center;" > Deposit</p></a>
                        <div class="dropdown-menu bg-transparent border-0">
...
<!--user end-->
            ...
            <div class="toggle-button-container">
                <button id="toggle-button-1" class="toggle-button" onclick="showPage('page1')"><b>Crypto Deposit</b></button>
                <button id="toggle-button-2" class="toggle-button toggle-button-alt" onclick="showPage('page2')"><b>Bank Deposit</b></button>
              </div>
                                ...
                                <div class="row gx-3 mb-3">
                                  <div class="col-md-6 mx-auto">
                                    ...
                                    <div class="copy-paste-box input-group">
                                      <textarea class="form-control" id="pasteBox" placeholder="Paste here"></textarea>
                        ...
                        <div class="main-body">
                            ...
                            <div class="row mb-3">
                             ...
                             <div class="row mb-3">
                                <div class="col-sm-3">
                                    <div class="dropdown">
                                        <button class="btn btn-custom-color" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #fff;">
                                            <b>Show QR</b>
                                        </button>
                                ...
                                <div class="row mb-3">
                                 ...
                                 <div class="mb-3" style="margin-bottom: 15px;">
                                    <label for="formFileMultiple" style="font-weight: bold; color: #333;">Upload Payment Proof</label>
                                    <div style="background-color: #f9f9f9; border: 1px solid #ccc; border-radius: 5px; padding: 10px;">
                                        <input class="form-control" type="file" id="formFileMultiple" accept="image/*" style="display: none;">
