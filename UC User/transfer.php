         ...
         <div class="sidebar pe-4 pb-3">
            <nav  class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="transfer.php" class="nav-item nav-link active active"><i class="fa fa-exchange-alt me-2"></i>Transfer</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="card rounded bg-light text-center">
                            <img style="margin: auto; width: 80px; height: 80px;" src="img/bitcoin.png" class="card-img-top" alt="Coupon Image">
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="card rounded bg-light text-center">
                            <img style="margin: auto; width: 80px; height: 80px;" src="img/circle.png" class="card-img-top" alt="Coupon Image">
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="card rounded bg-light text-center">
                            <img style="margin: auto; width: 80px; height: 80px;" src="img/steps.png" class="card-img-top" alt="Coupon Image">
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="card rounded bg-light text-center">
                            <img style="margin: auto; width: 80px; height: 80px;" src="img/house fund.png" class="card-img-top" alt="Coupon Image">
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="card rounded bg-light text-center">
                            <img style="margin: auto; width: 80px; height: 80px;" src="img/star.png" class="card-img-top" alt="Coupon Image">
...
<div class="d-flex justify-content-center">
    <div class="col-sm-12 col-md-8 col-lg-6 col-xl-5"> <!-- Increase col-xl-8 to increase form width -->
        <div class="bg-light rounded h-100 p-4">
            <h4 style="text-align: center;" class="mb-4">Transfer</h4>
            <div class="form-floating mb-3">
                <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                    ...
                    <option value="4">Car & House Fund</option>
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="Dollar Value" placeholder="Dollar Value">
                <label for="Dollar Value">Dollar Value</label>
            </div>
            <div class="d-flex justify-content-center">
                <a href="#">
                    <button type="button" class="btn btn-primary m-2">Transfer</button>
                </a>
            </div>
        </div>
    </div>
