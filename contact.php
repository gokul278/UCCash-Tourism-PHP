    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4">Contact us - <span style="color:#F7C128;" >World's leading tour Booking</span></h1>
        ...
        <div class="container-fluid contact bg-light py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h1 class="mb-0">Contact For <span style="color: #F7C128;">Any Query</span></h1>
                </div>
                <div class="row g-5 align-items-center">
                    <div style="color: #000;" class="col-lg-4">
                        <div class="bg-white rounded p-4">
                            <div class="text-center mb-4">
                                <i class="fa fa-map-marker-alt fa-3x text-primary"></i>
                                <h4 class="text-primary"><Address></Address></h4>
                                <p class="mb-0"><b>UCCASH Tourism,1st Floor, Selvam Complex,Kurukkuppatti Junction, Tharamangalam,Salem DT, Tamilnadu,India,
                                    <br>PIN-636502</p></b>
                            </div>
                            <div class="text-center mb-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mb-0"><a style="color: #000;" href="mailto:support@uccashtourism.com" target="_blank" ><b>support@uccashtourism.com</b></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <h3 class="mb-2">Send us a message</h3>
                        <p class="mb-4"><b>Leading tour and travels community, With over 50+ packages worldwide. Book travel packages and enjoy your holidays with distinctive experience.</b></p>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="rounded">
                            ...
                            style="height: 450px;" src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d6745.6375739396!2d77.980093!3d11.69614!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTHCsDQxJzQ2LjEiTiA3N8KwNTgnNDguMyJF!5e1!3m2!1sen!2sin!4v1707060988195!5m2!1sen!2sin" 
