...
--
-- Host: localhost:3306
-- Generation Time: May 16, 2024 at 09:05 PM
...
(1, '20240515064536_20240514082930_1000184857.jpg');
...
(11, 'UCT1010', 'e914e89ae6945bab0286af214d2ede0d', 'Vignesh Kumar K', NULL, NULL, NULL, NULL, 'vignesh123rb@gmail.com', '+918220402013', NULL, NULL, NULL, 'Konganaburam ', 'Salem', '637102', 'Tamil Nadu', 'India', 'UCT1003', 'notactivated', '2024-05-14 03:41:41', '2024-05-14 03:41:41'),
...
--
ALTER TABLE `availablewithdrwabalance`
  MODIFY `awb_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bonustravelpoints`
--
ALTER TABLE `bonustravelpoints`
  MODIFY `bt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `carandhousefundwallet`
--
ALTER TABLE `carandhousefundwallet`
  MODIFY `chfw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `leadershipincomewallet`
  MODIFY `liw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `networkingincomewallet`
  MODIFY `niw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `royaltyincomewallet`
--
ALTER TABLE `royaltyincomewallet`
  MODIFY `riw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
