...
(1, 'UCT000000', 'Dr. P. Balakrishnnan', '9283a03246ef2dacdc21a9b137817ec1', 'test@admin.com', '20240602042913_20240510022859_bill_image_413460_1629269700353 (1).jpg');
...
CREATE TABLE `bonustravelpoints` (
  ...
  `bt_bonusfrom` varchar(100) NOT NULL,
...
(66, 'MSI-66', 'UCT1003', '50$', '5', '55', 'pending', NULL, '2024-06-06 04:44:07'),
...
(4, 'UCT1012', '5', 'UCT1023', 'credit', 'Savings Income', '2024-05-29 11:12:08'),
(5, 'UCT1012', '5', 'UCT1022', 'credit', 'Savings Income', '2024-05-29 11:12:50'),
(6, 'UCT1012', '5', 'UCT1021', 'credit', 'Savings Income', '2024-05-29 11:13:44'),
(7, 'UCT1012', '5', 'UCT1019', 'credit', 'Savings Income', '2024-05-29 11:13:46'),
(8, 'UCT1012', '5', 'UCT1017', 'credit', 'Savings Income', '2024-05-29 16:41:48');
...
CREATE TABLE `savingstravelpoints` (
  ...
  `user_id` varchar(20) NOT NULL,
  `st_points` varchar(100) NOT NULL,
  `st_action` varchar(100) NOT NULL,
  `st_bonusfrom` varchar(100) NOT NULL,
  `st_remark` varchar(100) NOT NULL,
...
CREATE TABLE `travelcouponpoints` (
  ...
  `tc_remark` varchar(100) NOT NULL,
...
(1, 'UCT1003', 'BALAKRISHNAN P', 'STATE BANK OF INDIA', '33954688098', 'SBIN0018402', 'KONGANAPURAM', 'TE7E8gMA8myKGYUUvxyZEhtJzkQyqHPAMa', '0x0e5fDeD11073B688a09c3960f7240a1D38C92Ec7', '837183'),
...
(3, 'UCT1002', '1c2959c174c03bee51f726cdcdf34dc7', 'BALAKRISHNAN P', '', 'male', '20240510022859_bill_image_413460_1629269700353.jpg', '', 'uccashbala@gmail.com', '+919842434284', '', '', '', '2 140A, PANDARANGADU, KONASAMUDRAM PO,  EDAPPADI TK,  SALEM DT,', 'Salem', '637102', 'Tamil Nadu', 'India', 'UCT1001', 'activated', '2024-05-07 09:44:31', '2024-05-25 09:30:39'),
...
--
ALTER TABLE `admin_wallet`
  MODIFY `aw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `bonustravelpoints`
  MODIFY `bt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;

--
-- AUTO_INCREMENT for table `carandhousefundwallet`
--
ALTER TABLE `carandhousefundwallet`
  MODIFY `chfw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `leadershipincomewallet`
  MODIFY `liw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `networkingincomewallet`
  MODIFY `niw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `royaltyincomewallet`
  MODIFY `riw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `travelcouponpoints`
  MODIFY `tc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
