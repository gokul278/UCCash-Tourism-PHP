...
--
-- Host: localhost:3306
-- Generation Time: Jun 23, 2024 at 10:56 AM
...
(1, 'UCT000000', 'Dr. P. Balakrishnnan', '9283a03246ef2dacdc21a9b137817ec1', 'admin@uccashtourism.com', '20240608075828_20240510022859_bill_image_413460_1629269700353 (1).jpg', NULL, NULL);
...
(5, 'UCT1004', '728d91e1c5cbd3844efbc119bd2b90f9', 'P MURUGAN', 'Ponnusamy', 'male', '20240622051155_1000072185.jpg', '1968-03-23', 'myvgmurugan@gmail.com', '+918940017939', '537127052582', 'ATIPM5882B', 'married', 'Salem', 'Salem', '636004', 'Tamil Nadu', 'India', 'UCT1003', 'activated', '2024-05-07 12:55:27', '2024-06-22 05:11:55'),
...
(2, '2024-06-22 01:19:35', 'UCT1003', 'Bank', '10', '0.50', '0.50', '9.00', 'BALAKRISHNAN P,<br>STATE BANK OF INDIA,<br>33954688098,<br>SBIN0018402,<br>KONGANAPURAM', 'pending', 'waiting for Payment', 'admin');
...
--
ALTER TABLE `bonustravelpoints`
  MODIFY `bt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;

--
-- AUTO_INCREMENT for table `carandhousefundwallet`
--
ALTER TABLE `carandhousefundwallet`
  MODIFY `chfw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `leadershipincomewallet`
  MODIFY `liw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
--
ALTER TABLE `networkingincomewallet`
  MODIFY `niw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
...
--
ALTER TABLE `royaltyincomewallet`
  MODIFY `riw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
