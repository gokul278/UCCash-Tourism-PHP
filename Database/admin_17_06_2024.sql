...
--
-- Host: localhost:3306
-- Generation Time: Jun 17, 2024 at 02:39 PM
...
INSERT INTO `admindetails` (`id`, `admin_id`, `admin_name`, `admin_password`, `admin_email`, `admin_profile`) VALUES
(1, 'UCT000000', 'Dr. P. Balakrishnnan', '9283a03246ef2dacdc21a9b137817ec1', 'test@admin.com', '20240608075828_20240510022859_bill_image_413460_1629269700353 (1).jpg');
...
(2, '100', 'debit', 'For Nagarcoin Team visiting expenses', '2024-06-15 07:12:34');
...
(1, '20240506203818_trc20 (1).jpeg', 'TK8XreREARoQse2B9xPMidL7WWNVHZSb2c', '$ 59', '20240509151020_Screenshot_2024_0509_195359.jpg', 'UCCASH TOURISM PRIVATE LIMITED ', '42730402390', 'SBIN0018402', 'KONGANAPURAM', 'uccashtourism@sbi', 'Rs 5310');
...
(65, 'MSI-65', 'UCT1002', '50$', '5', '55', 'pending', NULL, '2024-06-06 04:44:04'),
...
(85, 'MSI-85', 'UCT1017', '50$', '5', '55', 'pending', NULL, '2024-06-16 18:30:05'),
(86, 'MSI-86', 'UCT1018', '50$', '5', '55', 'pending', NULL, '2024-06-16 18:30:09'),
(87, 'MSI-87', 'UCT1019', '50$', '5', '55', 'pending', NULL, '2024-06-16 18:30:13'),
(88, 'MSI-88', 'UCT1020', '50$', '5', '55', 'pending', NULL, '2024-06-16 18:30:17'),
(89, 'MSI-89', 'UCT1021', '50$', '5', '55', 'pending', NULL, '2024-06-16 18:30:21'),
(90, 'MSI-90', 'UCT1022', '50$', '5', '55', 'pending', NULL, '2024-06-16 18:30:24'),
(91, 'MSI-91', 'UCT1023', '50$', '5', '55', 'pending', NULL, '2024-06-16 18:30:28'),
...
INSERT INTO `tourdestination` (`id`, `tour_thumbnail`, `tour_image1`, `tour_image2`, `tour_image3`, `tour_image4`, `tour_image5`, `tour_name`, `tour_bookingcode`, `tour_days`, `tour_fromdate`, `tour_todate`, `tour_amount`, `tour_daysplan`, `tour_inclusion`, `tour_exclusion`, `tour_createdat`) VALUES
(2, '202406111330000_1000220629.jpg', '202406111330001_1000220632.jpg', '202406111330002_1000209598.jpg', '202406111330003_1000209602.jpg', '202406111330004_1000220641.jpg', '202406111330005_1000209590.jpg', 'Thailand', 'UCTB001', '3N/4D', '2024-07-27', '2024-07-30', '600', '[\"Depot Bangkok Airport to Pattaya Transfer via Sriracha Tiger zoo with Breakfast and hotel check in 2:00pm and Alcazar show 7:00pm\",\"Coral Islands visit with Launch and evening local city Tour with private transfer \",\"Floting market and Nong Nooch Village visit with Launch \",\"Gems Gallery visit and under water world \"]', 'All food and Tickets with transport ', 'Extra your expenses like liquors and other Tips ', '2024-06-11 13:30:00');
...
(1, 'UCT1003', 'BALAKRISHNAN P', 'STATE BANK OF INDIA', '33954688098', 'SBIN0018402', 'KONGANAPURAM', 'TE7E8gMA8myKGYUUvxyZEhtJzkQyqHPAMa', '0x0e5fDeD11073B688a09c3960f7240a1D38C92Ec7', ''),
...
(4, 'UCT1003', '1c2959c174c03bee51f726cdcdf34dc7', 'ADMIN', 'ADMIN', 'male', '20240603094818_20240603_151744_0000.png', '1984-04-10', 'uccashtourism@gmail.com', '+918124779993', '986264407489', 'ATPPB3908E', 'unmarried', '2 140A, PANDARANGADU, KONASAMUDRAM PO,  EDAPPADI TK,  SALEM DT,', 'Salem', '637102', 'Tamil Nadu', 'India', 'UCT1002', 'activated', '2024-05-07 09:50:01', '2024-06-03 09:48:18'),
(5, 'UCT1004', '728d91e1c5cbd3844efbc119bd2b90f9', 'P MURUGAN', 'Ponnusamy', 'male', '20240604115232_1000066602.jpg', '1968-03-23', 'myvgmurugan@gmail.com', '+918940017939', '537127052582', 'ATIPM5882B', 'married', 'Salem', 'Salem', '636004', 'Tamil Nadu', 'India', 'UCT1003', 'activated', '2024-05-07 12:55:27', '2024-06-04 11:52:32'),
...
(10, 'UCT1009', '7aa0c32c6b7ff07264ba0e3d02262475', 'S. Meganathan', NULL, 'male', '20240615105500_1000155505.jpg', '', 'megansemmalai@gmail.com', '+919952474033', '', '', 'married', 'Dadapuram post\nV. Valasai via\nEdappadi tk\nSalem Dt\n', 'Edappadi', '637105', 'Tamil Nadu', 'India', 'UCT1003', 'activated', '2024-05-09 05:46:40', '2024-06-15 10:55:12'),
...
--
ALTER TABLE `availablewithdrwabalance`
  MODIFY `awb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `bonustravelpoints`
--
ALTER TABLE `bonustravelpoints`
  MODIFY `bt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `carandhousefundwallet`
--
ALTER TABLE `carandhousefundwallet`
  MODIFY `chfw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
--
ALTER TABLE `leadershipincomewallet`
  MODIFY `liw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
--
ALTER TABLE `networkingincomewallet`
  MODIFY `niw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
...
--
ALTER TABLE `royaltyincomewallet`
  MODIFY `riw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `savingsincome`
--
ALTER TABLE `savingsincome`
  MODIFY `si_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `uccwalletpoints`
  MODIFY `uccw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
