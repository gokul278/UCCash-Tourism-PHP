...
--
-- Host: localhost:3306
-- Generation Time: Jun 01, 2024 at 01:42 PM
...
(1, 'UCT000000', 'Dr. P. Balakrishnnan', '9283a03246ef2dacdc21a9b137817ec1', 'test@admin.com', NULL);
...
(1, '20240521105133_1000195635.jpg');
...
(34, 'UCT1033', 'dd7d59983018404266fcc4e0962442e7', 'N P THIYAKU', NULL, NULL, NULL, NULL, 'kpthiyagarajan2014@gmail.com', '+918903934955', NULL, NULL, NULL, 'Kolli hills', 'Namakkal', '637411', 'Tamil Nadu', 'India', 'UCT1003', 'notactivated', '2024-05-31 10:06:16', '2024-05-31 10:06:16');
...
--
ALTER TABLE `bonustravelpoints`
  MODIFY `bt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `carandhousefundwallet`
--
ALTER TABLE `carandhousefundwallet`
  MODIFY `chfw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `leadershipincomewallet`
  MODIFY `liw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `networkingincomewallet`
  MODIFY `niw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `royaltyincomewallet`
  MODIFY `riw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `uccwalletpoints`
  MODIFY `uccw_id` int(11) NOT NULL AUTO_INCREMENT;
