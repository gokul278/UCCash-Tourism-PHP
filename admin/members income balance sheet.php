...
<head>
    <meta charset="utf-8">
    <title>Member's Income Balance Sheet</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="members income balance sheet.php" class="nav-item nav-link active"><i class="fa fa-file-invoice-dollar me-2"></i>Member's<p style="text-align: center;">Income Balance Sheet</p></a>
