       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="members details.php" class="nav-item nav-link active"><i class="fa fa-users me-2"></i>Member's <p style="text-align: center;">Details</p></a>
                <div class="nav-item dropdown">
...
<br><br>
            ...
            <style>
                /* Custom CSS to change table border color */
                .table-bordered {
...
<!-- <script>
    function printPDF() {
        var printContents = document.getElementById('table-to-print').outerHTML;
