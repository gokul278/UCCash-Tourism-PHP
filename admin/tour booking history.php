        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div id="sidebar" class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-bookmark me-2"></i>Tour
                            Booking<p style="text-align: center;"> History</p></a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="tour booking history.php" class="dropdown-item active" style="color:#f7c128">International History</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">International Tour Booking History</h4>
                            <!-- Search Filters -->
                            <div class="row mb-3">
