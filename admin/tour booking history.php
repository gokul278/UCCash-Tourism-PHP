...
<head>
    <meta charset="utf-8">
    <title>Tour Booking History</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="tour booking history.php" class="nav-item nav-link active"><i class="fa fa-bookmark me-2"></i>Tour Booking<p style="text-align: center;"> History</p></a>
