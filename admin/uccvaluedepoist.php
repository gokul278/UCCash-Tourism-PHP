...
<head>
    <meta charset="utf-8">
    <title>UCC Value Deposite</title>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="savings TP today value.php" class="dropdown-item"><b>Saving's TP Today<p>
                                        Value Edit</p></b></a>
                            <a href="uccvaluedepoist.php" style="color:#f7c128" class="dropdown-item active"><b>UCC
                                    Value Deposit</b></a>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">UCC Value Deposit</h4>
