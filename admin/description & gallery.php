...
<head>
    <meta charset="utf-8">
    <title>Description & Gallery</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="far fa-file-alt me-2"></i>ID Activation</a>
                        <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="far fa-file-alt me-2"></i>Withdraw</a>
                        <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <!-- <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Hotel Booking<p
                            style="text-align: center;"> Edit</p></a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Hotel Booking<p
                            style="text-align: center;"> History</p></a> -->
                    <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Member's<p
                            style="text-align: center;"> Balance Sheet</p></a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Company<p
                            style="text-align: center;"> Balance Sheet</p></a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Fast Start<p
                            style="text-align: center;"> Report</p></a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Business<p
                            style="text-align: center;"> Tools Edit</p></a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Information<p
                            style="text-align: center;"> Edit</p></a>
