...
<head>
    <meta charset="utf-8">
    <title>Travel Coupon Usage History</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="travel coupon usage history.php" class="nav-item nav-link active"><i class="fa fa-star me-2"></i>Travel Coupon<p style="text-align: center;">Usage History</p></a>
                ...
                <div class="row">
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Travel Coupon Usage History</h4>
                                ...
                                <strong><table id="table-to-print" style="text-align: center;" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#">
                                                    <button type="button" class="btn btn-warning"><b>Bill Invoice</b></button>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
