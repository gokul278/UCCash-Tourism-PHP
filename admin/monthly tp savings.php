...
<head>
    <meta charset="utf-8">
    <title>Monthly TP Savings Approval</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-donate me-2"></i>Monthly TP<p style="text-align: center;"> Savings</p></a>
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="monthly tp savings.php" class="dropdown-item active">Monthly TP Saving's <p>Approval</p></a>
                                ...
                                <strong><table id="table-to-print" style="text-align: center;" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#">
                                                    <button type="button" class="btn btn-warning"><b>Edit</b></button>
                                                </a>
