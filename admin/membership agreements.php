...
<head>
    <meta charset="utf-8">
    <title>Membership Agreements</title>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="membership agreements.php" class="dropdown-item active"  style="color:#f7c128">Membership Agreements</a>
                        ...
                        <div class="col-12">
                            <form id="pdfsave">
                                <div class="bg-secondary rounded h-100 p-4" style="display: inline-block;">
                                    <h4 style="color: #f7c128;" class="mb-5">Membership Agreements
                                    </h4>
                                ...
                                <input type="hidden" name="way" value="mapdfupload">
                            </form>
                        </div>
                    </div>
                </div>
