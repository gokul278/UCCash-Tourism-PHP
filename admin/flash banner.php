                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="flash banner.php" class="dropdown-item active" style="color:#f7c128"><b>Flash
                                    Banner Upload</b></a>
            ...
            <div style="text-align: center;">
                                    ...
                                    <div class="mb-3" style="margin-bottom: 15px; max-width: 300px;">
                                        ...
                                        <div
                                            ...
                                            <input class="form-control" type="file" id="formFileMultiple"
                                                accept="image/*" onchange="displayFileName()" style="display: none;"
                                                name="flashbanner" required>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="bg-secondary rounded h-100 p-4" style="display: inline-block;">
                                <h4 style="color: #f7c128;" class="mb-5">Delete Flash Banner</h4>
                                <div class="mb-3" style="margin-bottom: 15px; max-width: 300px;">
                                    <div id="bannerimg"
