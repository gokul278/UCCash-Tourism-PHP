...
<head>
    <meta charset="utf-8">
    <title>Hotel Booking Edit</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="hotel booking edit.php" class="nav-item nav-link active"><i class="fa fa-bookmark me-2"></i>Hotel Booking<p style="text-align: center;"> Edit</p></a>
                ...
                <div class="row">
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Hotel Booking Edit</h4>
