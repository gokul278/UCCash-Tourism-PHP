...
<head>
    <meta charset="utf-8">
    <title>Tour Description Edit</title>
...
<body>
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        ...
                        <a href="tour description.php" class="dropdown-item active">Tour Description</a>
                ...
                <div class="row align-items-center justify-content-center mx-0">
                    <div class="col-md-8 text-center text-white">
                        <div class="border rounded p-4">
                            <h4 style="color: #f7c128;">Tour Description Edit</h4>
                            <br>
                            <textarea id="newsTextArea" class="form-control text-white" style="height: 300px; border-color: #f7c128;" rows="4" placeholder="Enter Tour Description Here"></textarea>
                            <br>
    ...
    <script>
        // Retrieve the text from localStorage if it exists
        ...
        document.getElementById("uploadButton").addEventListener("click", function() {
            ...
            localStorage.setItem("latestNews", newsText);
            // Optionally, you can perform an upload action here
            // For demonstration purpose, let's log the text to console
            console.log("Text uploaded:", newsText);
        });
    </script>
