...
<head>
    <meta charset="utf-8">
    <title>Saving's TP Today Value</title>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div  class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="savings TP today value.php" class="dropdown-item active"><b>Saving's TP Toady<p> Value Edit</p></b></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">    
                            <div class="bg-secondary rounded h-100 p-4" style="display: inline-block;">
                                <h4 style="color: #f7c128;" class="mb-5">Saving's TP Today Value Edit</h4>
                                <div class="mb-3" style="margin-bottom: 15px; max-width: 300px;">
                                    <input class="form-control" type="text" id="imageURL" placeholder="Enter Saving's TP Today Value" style="max-width: 300px; height: 60px;">
                                </div>
                                <br>
