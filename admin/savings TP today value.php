...
<body>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="savings TP today value.php" class="dropdown-item active"
                                style="color:#f7c128"><b>Saving's TP Today<p>
                                        Value Edit</p></b></a>
                        </div>
                    </div>
                            ...
                            <form id="uccvalueupdate">
                                <div class="bg-secondary rounded h-100 p-4" style="display: inline-block;">
                                    ...
                                    <div class="mb-3" style="margin-bottom: 15px; max-width: 300px;">
                                        <input class="form-control" type="text" id="uccvalue"
                                            placeholder="Enter Saving's TP Today Value"
                                            style="max-width: 300px; height: 60px;" required>
                                    </div>
                                    <br>
    ...
    <script src="./requiredFiles/js/savingsTPtodayvalue.js"></script>
</body>
