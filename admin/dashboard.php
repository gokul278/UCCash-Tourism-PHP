        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="dashboard.php" class="nav-item nav-link active"><i  class="fa fa-tachometer-alt me-2"></i><b>Dashboard</b></a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-id-card me-2"></i>ID Activation</a>
                        <div class="dropdown-menu bg-transparent border-0">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card rounded custom-bg-color text-center custom-height-card">
                            <div class="card-body">
                                ...
                                <br>
                                <h5 class="card-text mb-0 text-color-custom">0.00</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card rounded custom-bg-color text-center custom-height-card">
                            <div class="card-body">
                                <h5 class="card-title mb-2">Saving's Member</h5>
                                <br>
                                <h5 class="card-text mb-0 text-color-custom">0.00</h5>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card rounded custom-bg-color text-center custom-height-card">
                            <div class="card-body">
                                <h5 class="card-title mb-2">Withdraw Network Income</h5>
                                <br>
                                <h5 class="card-text mb-0 text-color-custom">0.00</h5>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card rounded custom-bg-color text-center custom-height-card">
                            <div class="card-body">
                                <h5 class="card-title mb-2">Admin Wallet Balance</h5>
                                <br>
                                <h5 class="card-text mb-0 text-color-custom">0.00</h5>
                            </div>
                        </div>
