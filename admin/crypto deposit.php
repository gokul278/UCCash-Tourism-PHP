            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4">
                        <h4 style="color: #f7c128;" class="mb-5">Crypto Deposit Edit</h4>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="depositAddress" placeholder="Deposit Address">
                            <label for="depositAddress">Deposit Address</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="tel" class="form-control" id="depositValue" placeholder="Deposit Value">
                            <label for="depositValue">Deposit Value</label>
                        </div>
            
                        <!-- Center the Update Button -->
                        <div class="d-flex justify-content-center">
                            <button onclick="saveData()" type="button" class="btn btn-primary">Update</button>
                        </div>
...
<script>
    ...
    function saveData() {
        var depositAddress = document.getElementById("depositAddress").value;
        var depositValue = document.getElementById("depositValue").value;

        localStorage.setItem("depositAddress", depositAddress);
        localStorage.setItem("depositValue", depositValue);
    }

    // Load saved data when the page loads
    window.onload = function() {
        var savedAddress = localStorage.getItem("depositAddress");
        var savedValue = localStorage.getItem("depositValue");

        if (savedAddress) {
            document.getElementById("depositAddress").value = savedAddress;
        }
        if (savedValue) {
            document.getElementById("depositValue").value = savedValue;
        }
    }
</script>
</body>
