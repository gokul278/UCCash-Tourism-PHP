$(document).ready(() => {
  $.ajax({
    type: "POST",
    url: "./requiredFiles/ajax/bonustravelpointusagehistoryAjax.php",
    data: {
      way: "login",
    },
...
function exportToExcel() {
  ...
  var wb = XLSX.utils.table_to_book(table, { sheet: "Bonus Travel Points" });
  XLSX.writeFile(wb, "Bonus_Travel_Point_Usage_History.xlsx");
}
