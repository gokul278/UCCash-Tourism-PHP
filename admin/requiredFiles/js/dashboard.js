  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      if (response.status == "success") {
        ...
        $("#totalavailablewithdrwabalance").html(
          response.totalavailablewithdrwabalance + "$"
        );
        $("#usedavailablewithdrwabalance").html(
          response.usedavailablewithdrwabalance + "$"
        );
        $("#balanceavailablewithdrwabalance").html(
          response.balanceavailablewithdrwabalance + "$"
        );

        $("#totalreactivationwallet").html(
          response.totalreactivationwallet + "$"
        );
        $("#usedreactivationwallet").html(
          response.usedreactivationwallet + "$"
        );
        $("#balancereactivationwallet").html(
          response.balancereactivationwallet + "$"
        );
