...
if ($values["status"] == "success") {
    ...
    if ($way == "login") {
        ...
        $query = "SELECT * FROM domestictourbookinghistory tbh WHERE tbh.status = 'booked'";
        ...
        $data = $con->query("SELECT * FROM domestictourbookinghistory WHERE status = 'visited'");
        ...
        $update = $con->query("UPDATE domestictourbookinghistory SET status='visited' WHERE id='{$id}'");
