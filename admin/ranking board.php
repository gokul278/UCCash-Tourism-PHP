       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="ranking board.php" class="nav-item nav-link active"><i class="fa fa-signal me-2"></i>Ranking Board</a>
                <div class="nav-item dropdown">
                    ...
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="input-group mb-3 mt-auto">
                                        <input type="text" class="form-control" id="activationMemberID" style="max-width: 200px;" placeholder="User ID">
                            ...
                            <div class="table-responsive">
                                <strong><table id="table1" style="text-align: center;" class="table table-bordered">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" onclick="toggleTables()"><button type="button" class="btn btn-warning"><b>View</b></button></a>
                                            </td>
                                        </tr>
                            ...
                            <div class="table-responsive hidden" id="table2">
                                <strong><table style="text-align: center;" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th scope="col">S.NO</th>
                                            <th scope="col">Rank</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#">
                                                    <button type="button" class="btn btn-warning"><b>Update</b></button>
                                                </a>
                                            </td>
                                        </tr>
                                ...
                                <div id="backButton" class="show">
                                    <a href="#" onclick="toggleTables()"><button type="button" class="btn btn-warning"><b>Back</b></button></a>
                                </div>
                            </div>
