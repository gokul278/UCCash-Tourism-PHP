                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="travel coupon activation.php" class="dropdown-item active" style="color:#f7c128">ID
                                Activation</a>
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4 d-flex flex-column">
                        ...
                        <div class="form-floating mb-3 mt-auto text-end">
                            <input type="text" class="form-control" oninput="activationenablebtn()" id="activationvalue"
                                placeholder="">
                            <label for="activationMemberID">ID Activation Value</label>
                        </div>
                        <div class="d-flex justify-content-center">
                            <button class="btn btn-primary btn-lg mt-4" id="activationbtn"
                                onclick="updateactivationvalue()" disabled>Update</button>
                        </div>
                        <br>
                        <form id="idactivationsubmit">
                            <h4 style="color: #f7c128;" class="mb-4">ID Activation</h4>
                            <div class="form-floating mb-1 mt-auto text-end">
                                <input type="text" class="form-control" id="activationMemberID" name="userid"
                                    oninput="getusername()" onclick="clearerror()" placeholder="" required>
                                <label for="activationMemberID">Activation Member ID</label>
                            </div>
                            <input type="hidden" name="way" value="idactivation">
                            <div class="mb-3;" id="username">
                                <p>Enter the Valid User</p>
                            </div>
                            <div class="form-floating mb-3 mt-auto text-end">
                                <input type="hidden" name="cryptovalue" id="cryptovalue">
                                <input type="text" class="form-control" id="crypto_value" name="cryptovalue"
                                    placeholder="" disabled>
                                <label for="activationAmount">Activation Amount</label>
                            </div>
                            <div class="form-floating mb-3 mt-auto text-end">
                                <input type="password" class="form-control" id="adminPassword" onclick="clearerror()"
                                    name="adminpass" placeholder="" required>
                                <label for="adminPassword">Admin Password</label>
                            </div>
                            <div class="form-floating mb-3 mt-auto text-center">
                                <input type="text" class="form-control" onclick="clearerror()" id="TXNID" name="txnid"
                                    placeholder="" required>
                                <label for="TXNID">TXN ID</label>
                            </div>
                            <p style="color:red" align="center" id="errormsg"></p>
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-primary btn-lg mt-4" id="activatebtn"
