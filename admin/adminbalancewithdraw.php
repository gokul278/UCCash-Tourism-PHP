...
<head>
    <meta charset="utf-8">
    <title>Admin Balance Withdraw</title>
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="adminbalancewithdraw.php" class="nav-item nav-link active"><i
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-8">
                        <form id="withdrawamount">
                            <div class="bg-secondary rounded h-100 p-4">
                                <h4 style="color: #f7c128;" class="mb-3">Admin Balance Withdraw</h4>
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" name="wallettype"
                                                aria-label="Floating label select example" required>
                                                <option value="" selected>Select Wallet</option>
                                                <option value="adminwalletbalance">Admin Wallet Balance</option>
                                                <option value="admingstbalance">Admin GST Balance</option>
                                            </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <label for="referralid" class="col-form-label">Withdraw Amount</label>
                                        <input type="tel" class="form-control disabled-input" name="withdrawamount"
                                            id="withdrawamountval" style="height: 50px;" onclick="clearerror()"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="tel" class="form-control disabled-input" name="description"
                                            id="description" style="height: 50px;" onclick="clearerror()" required>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label for="referralid" class="col-form-label">Password</label>
                                        <input type="password" class="form-control disabled-input" name="password"
                                            id="password" style="height: 50px;" onclick="clearerror()" required>
                                    </div>
                                </div>
                                <div align="center">
                                ...
                                <!-- <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <label for="referralid" class="col-form-label">OTP</label>
                                        <input type="number" class="form-control disabled-input" id="otp"
                                            style="height: 50px;" required>
                                    </div>

                                    <div class="col-sm-6">
                                        <button type="button" class="btn btn-warning"
                                            style="margin-top: 37px;width:100%;height: 49px;"><b>Get OTP</b></button>
                                    </div>
                                </div> -->
                                <div class="row mb-4">
                                    <div class="col-2"></div>
                                    <div class="col-8">
                                        <input type="hidden" name="way" value="withdrawamount">
                                        <button type="submit" class="btn btn-warning"
                                            style="width:100%;height: 49px;"><b>Withdraw</b></button>
                                    </div>
                                    <div class="col-2"></div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Admin Balance Withdraw History</h4>
    ...
    <script src="./requiredFiles/js/adminbalancewithdraw.js"></script>
