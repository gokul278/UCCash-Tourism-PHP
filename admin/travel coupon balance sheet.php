...
<head>
    <meta charset="utf-8">
    <title>Travel Coupon Balance Sheet</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="travel coupon balance sheet.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Travel Coupon <p style="text-align: center;">Balance Sheet</p></a>
                ...
                <div class="row">
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Travel Coupon Balance Sheet</h4>
                            <div class="row">
                                <div class="col-sm-6">
