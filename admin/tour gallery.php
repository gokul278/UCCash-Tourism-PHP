                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="tour gallery.php" class="dropdown-item active" style="color:#f7c128">Gallery</a> -->
                                ...
                                <strong>
                                    <table id="table-to-print" style="text-align: center;" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">1</th>
                                                <td><img src="./img/taj mahal.jpg" style="width: 250px; height:200px;">
                                                </td>
                                            ...
                                            <tr>
                                                <th scope="row">2</th>
                                                <td><img src="./img/manarola.png" style="width: 250px; height:200px;">
                                                </td>
                                                <td class="text-center">
                                                    <a href="#">
                                                        <button type="button"
                                            ...
                                            <tr>
                                                <th scope="row">3</th>
                                                <td><img src="./img/family package.jpg"
                                            ...
                                            <tr>
                                                <th scope="row">4</th>
                                                <td><img src="./img/honeymoon package.jpg"
                                                        style="width: 250px; height:200px;"></td>
                                                <td class="text-center">
                                                    <a href="#">
                                                        <button type="button"
                                            ...
                                            <tr>
                                                <th scope="row">5</th>
                                                <td><img src="./img/singapore.jpg" style="width: 250px; height:200px;">
                                                </td>
                                                <td class="text-center">
                                                    <a href="#">
                                                        <button type="button"
