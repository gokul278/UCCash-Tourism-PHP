      ...
      <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="far fa-map me-2"></i>Tour Destination</a>
                    <div class="dropdown-menu bg-transparent border-0">
                        ...
                        <a href="tour gallery.php" class="dropdown-item active">Gallery</a>
                ...
                <div class="row">
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Tour Gallery Update</h4>
                            <div class="mb-3" style="margin-bottom: 15px; max-width: 300px;">
                                ...
                                <div style="background-color: #000; border: 1px solid #ccc; border-radius: 5px; padding: 10px;">
                                    ...
                                    <label for="formFileMultiple" style="cursor: pointer; background-color: #3498db; color: #fff; padding: 10px; border-radius: 5px;">Choose Image</label>
                                    <span id="fileName" style="margin-left: 10px;"></span>
                                    <button type="button" class="btn btn-primary">Upload</button>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <strong><table id="table-to-print" style="text-align: center;" class="table table-bordered">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td><img src="./img/taj mahal.jpg" style="width: 250px; height:200px;"></td>
                                        ...
                                        <tr>
                                            <th scope="row">2</th>
                                            <td><img src="./img/manarola.png" style="width: 250px; height:200px;"></td>
                                            <td class="text-center">
                                                <a href="#">
                                                    <button type="button" class="btn btn-danger"><b>Delete</b></button>
                                                </a>
                                        ...
                                        <tr>
                                            <th scope="row">3</th>
                                            <td><img src="./img/family package.jpg" style="width: 250px; height:200px;"></td>
                                            <td class="text-center">
                                                <a href="#">
                                                    <button type="button" class="btn btn-danger"><b>Delete</b></button>
                                                </a>
                                        ...
                                        <tr>
                                            <th scope="row">4</th>
                                            <td><img src="./img/honeymoon package.jpg" style="width: 250px; height:200px;"></td>
                                            <td class="text-center">
                                                <a href="#">
                                                    <button type="button" class="btn btn-danger"><b>Delete</b></button>
                                                </a>
                                        ...
                                        <tr>
                                            <th scope="row">5</th>
                                            <td><img src="./img/singapore.jpg" style="width: 250px; height:200px;"></td>
                                            <td class="text-center">
                                                <a href="#">
                                                    <button type="button" class="btn btn-danger"><b>Delete</b></button>
                                                </a>
