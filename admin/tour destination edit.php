            ...
            <div class="modal-body">
                <strong><form class="custom-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bookingCode" placeholder="Enter Image Country">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="days" placeholder="Enter from date">
                    </div>
                    <div class="form-group">
                        <label for="days">To Date :</label>
                        <input type="date" class="form-control" id="days" placeholder="Enter to date">
                    </div>
                    <div class="form-group">
