                ...
                <div id="sidebar" class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="topupapproval.php" class="dropdown-item ">Topup Wallet
                                Approval</a>
                            <a href="topuphistory.php" style="color:#f7c128" class="dropdown-item active">Topup Wallet History</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="withdraw history.php" class="dropdown-item active">Withdraw
                                History</a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Topup Wallet History</h4>
                            <!-- Search Filters -->
                            <div class="row mb-3">
