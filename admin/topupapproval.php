...
<body>
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div id="sidebar" class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="topupapproval.php" style="color:#f7c128" class="dropdown-item active">Topup Wallet
                                Approval</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="withdraw approval.php" class="dropdown-item active">Withdraw
                                Approval</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Topup Wallet Approval</h4>
    ...
    <script src="./requiredFiles/js/topupapproval.js"></script>
