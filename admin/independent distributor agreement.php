                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="independent distributor agreement.php" class="dropdown-item active">Independent
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bg-secondary rounded h-100 p-4" style="display: inline-block;">
                                <h4 style="color: #f7c128;" class="mb-5">Independent Distributor<p>Agreements Update</p>
                                </h4>
