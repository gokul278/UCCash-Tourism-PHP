                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="#" method="POST">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <input type="text" id="memberid" class="form-control mr-2" style="width: 180px;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="#" id="goButton" class="btn btn-primary">Go</a>
                        </div>
                        <br>
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <label for="placementID" class="col-form-label">Placement ID</label>
                                <input type="text" class="form-control disabled-input" id="placementID" disabled style="height: 50px;">
                            </div>
                            <div class="col-sm-6">
                                <label for="Placement" class="col-form-label">Placement</label>
                                <input type="text" class="form-control disabled-input" id="text" disabled style="height: 50px;">
                            </div>
                        </div>
