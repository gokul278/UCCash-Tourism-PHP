...
<head>
    <meta charset="utf-8">
    <title>Monthly - Crypto Deposit</title>
...
<body>
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="crypto deposit.php" class="dropdown-item">Crypto
                                Deposit</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="monthlycryptodeposite.php" class="dropdown-item active" style="color:#f7c128">Crypto Deposite</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                                    ...
                                    <form id="updateimage">
                                        ...
                                        <div
                                            ...
                                            <input class="form-control" type="file" id="formFileMultiple"
                                                accept="image/*" onchange="displayFileName()" name="updateimage"
                            ...
                            <form id="updateaddress">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="depositaddress" id="crypto_address"
                                        placeholder="Deposit Address" required>
                                    <label for="crypto_address">Deposit Address</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="tel" class="form-control" name="depositvalue" id="crypto_value"
                                        placeholder="Deposit Value" required>
                                    <label for="crypto_value">Deposit Value</label>
                                </div>
                                <input type="hidden" name="way" value="updateaddress">
    ...
    <script src="./requiredFiles/js/monthlycryptodeposite.js"></script>
