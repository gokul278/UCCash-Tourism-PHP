       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="fast start report.php" class="nav-item nav-link active"><i class="fa fa-file-alt me-2"></i>Fast Start<p style="text-align: center;"> Report</p></a>
                ...
                <div class="row">
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Fast Start Report</h4>
                                ...
                                <strong><table id="table-to-print" style="text-align: center;" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="yellow">Cashback Done</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            <td>UTC4321</td>
