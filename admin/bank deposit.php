        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-id-card me-2"></i>ID Activation</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="crypto deposit.php" class="dropdown-item">Crypto Deposit</a>
                            <a href="bank deposit.php" class="dropdown-item active">Bank Deposit</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-donate me-2"></i>Monthly TP<p style="text-align: center;"> Savings</p></a>
                        <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="bonus travel point usage history.php" class="nav-item nav-link"><i class="fa fa-gift me-2"></i>Bonus Travel<p style="text-align: center;"> Point Usage History</p></a>
                    <div class="nav-item dropdown">
                    ...
                    <a href="tour booking history.php" class="nav-item nav-link"><i class="fa fa-bookmark me-2"></i>Tour Booking<p style="text-align: center;"> History</p></a>
                    <a href="hotel booking edit.php" class="nav-item nav-link"><i class="fa fa-bookmark me-2"></i>Hotel Booking<p style="text-align: center;"> Edit</p></a>
                    <a href="hotel booking history.php" class="nav-item nav-link"><i class="fa fa-bookmark me-2"></i>Hotel Booking<p style="text-align: center;"> History</p></a>
                    <a href="members income balance sheet.php" class="nav-item nav-link"><i class="fa fa-file-invoice-dollar me-2"></i>Member's<p style="text-align: center;">Income Balance Sheet</p></a>
                    <a href="company balance sheet.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Company<p style="text-align: center;"> Balance Sheet</p></a>
                    <a href="member's bonus TP balance sheet.php" class="nav-item nav-link"><i class="fa fa-file-invoice-dollar me-2"></i>Member's<p style="text-align: center;"> Bonus Travel Point Balance Sheet</p></a>
                    <a href="fast start report.php" class="nav-item nav-link"><i class="fa fa-file-alt me-2"></i>Fast Start<p style="text-align: center;"> Report</p></a>
                    <a href="business tools.php" class="nav-item nav-link"><i class="fa fa-tools me-2"></i>Business Tools</a>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="independent distributor agreement.php" class="dropdown-item">Independent Distributor<p> Agreements</p></a>
                        </div>
                    </div>
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="mb-3" style="margin-bottom: 15px; max-width: 280px;">
                                ...
                                <div style="background-color: #000; border: 1px solid #ccc; border-radius: 5px; padding: 10px;">
                                    ...
                                    <label for="formFileMultiple" style="cursor: pointer; background-color: #3498db; color: #fff; padding: 10px; border-radius: 5px;">Choose QR Code</label>
                        ...
                        <div class="container">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="holderName" placeholder="A/C Holder Name">
                                <label for="holderName">A/C Holder Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="tel" class="form-control" id="accountNumber" placeholder="A/C Number">
                                <label for="accountNumber">A/C Number</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="ifscCode" placeholder="IFS Code">
                                <label for="ifscCode">IFS Code</label>
                            </div>
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="depositValue" placeholder="Deposit Value">
...
<script>
    ...
    function saveData() {
        localStorage.setItem('holderName', document.getElementById('holderName').value);
        localStorage.setItem('accountNumber', document.getElementById('accountNumber').value);
        localStorage.setItem('ifscCode', document.getElementById('ifscCode').value);
        localStorage.setItem('branch', document.getElementById('branch').value);
        localStorage.setItem('upiId', document.getElementById('upiId').value);
        localStorage.setItem('depositValue', document.getElementById('depositValue').value);
    }
    
    // Function to populate form fields with saved data
    window.onload = function() {
        document.getElementById('holderName').value = localStorage.getItem('holderName') || '';
        document.getElementById('accountNumber').value = localStorage.getItem('accountNumber') || '';
        document.getElementById('ifscCode').value = localStorage.getItem('ifscCode') || '';
        document.getElementById('branch').value = localStorage.getItem('branch') || '';
        document.getElementById('upiId').value = localStorage.getItem('upiId') || '';
        document.getElementById('depositValue').value = localStorage.getItem('depositValue') || '';
    };
    </script>
