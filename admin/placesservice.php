                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="news upload.php" class="dropdown-item active" style="color:#f7c128"><b>News
                                    Upload</b></a>
                ...
                <div class="row align-items-center justify-content-center mx-0">
                    <div class="col-md-8 text-center text-white">
                        <div class="border rounded p-4">
                            ...
                            <br>
                            <textarea id="newsTextArea" class="form-control text-white"
                                style="height: 300px; border-color: #f7c128;" rows="4"
                                placeholder="Enter the latest news here"></textarea>
                            <br>
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="dashboard.php" class="nav-item nav-link"><i
                            class="fa fa-tachometer-alt me-2"></i><b>Dashboard</b></a>
                    <a href="placesservice.php" class="nav-item nav-link active"><i
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Manage Images & Descriptions</h4>
                            <form id="addimage">
                                <div class="mb-3" style="margin-bottom: 15px; max-width: 300px;">
                                    ...
                                    <div
                                        ...
                                        <!-- Description Input -->
                                        <div class="mt-3">
                                            <label for="imageDescription" style="font-weight: bold; color: #fff;">Image Description</label>
                                            <textarea class="form-control bg-dark text-white" id="imageDescription" name="description" rows="3" placeholder="Enter image description" style="border-color: #f7c128;"></textarea>
                                        </div>
    ...
    <script src="./requiredFiles/js/placesservice.js"></script>
</body>
