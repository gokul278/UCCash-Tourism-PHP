...
<head>
    <meta charset="utf-8">
    <title>Member's Bonus TP Balance Sheet</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="member's bonus TP balance sheet.php" class="nav-item nav-link active"><i class="fa fa-file-invoice-dollar me-2"></i>Member's<p style="text-align: center;"> Bonus Travel Point Balance Sheet</p></a>
                ...
                <div class="row">
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Member's Bonus Travel Point Balance Sheet</h4>
                            <div class="row">
                                <div class="col-sm-6">
