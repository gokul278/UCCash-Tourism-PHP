                ...
                <div id="sidebar" class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="domestictourbookinghistory.php" class="dropdown-item active" style="color:#f7c128">Domestic History</a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Domestic Tour Booking History</h4>
                            <!-- Search Filters -->
                            <div class="row mb-3">
