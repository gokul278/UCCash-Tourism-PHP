       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-wallet me-2"></i>Withdraw</a>
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="withdraw approval.php" class="dropdown-item active">Withdraw Approval</a>
...
<br><br>
                                ...
                                <strong><table id="table-to-print" style="text-align: center;" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Crypto TXN ID</th>
                                            <th scope="col">Bank TXN ID</th>
        ...
        <!-- Content End -->
<!--Model Start-->
<div class="modal fade" id="exampleModal" tabdashboard="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <strong><form class="custom-form">
                    ...
                    <div class="form-group">
                        <label for="imgdescribe">Crypto TXN ID :</label>
                        <br>
                        <input type="text" class="form-control" id="bookingCode" placeholder="Enter Crypto TXN ID">
                    </div>
                    <br>
                    <br>
                    <div class="form-group">
                        <label for="bookingCode">Bank TXN ID :</label>
                        <br>
                        <input type="text" class="form-control" id="bookingCode" placeholder="Enter Bank TXN ID">
                    </div>
