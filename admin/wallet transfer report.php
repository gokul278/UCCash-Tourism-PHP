...
<head>
    <meta charset="utf-8">
    <title>Wallet Transfer Report</title>
       ...
       <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="wallet transfer report.php" class="nav-item nav-link active"><i class="fa fa-money-bill me-2"></i>Wallet Trasfer<p style="text-align: center;"> Report</p></a>
                ...
                <div class="row">
                    <div class="col-12">    
                        <div class="bg-secondary rounded h-100 p-4">
                            <h4 style="color: #f7c128;" class="mb-5">Wallet Transfer Report</h4>
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <strong><table id="table-to-print" style="text-align: center;" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Available Wallet</td>
                                            <td>50</td>
                                            <td class="green">Success</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            <td>01/02/2024 12:10 PM</td>
                                            <td>UCT4321</td>
                                            <td>Ashok</td>
