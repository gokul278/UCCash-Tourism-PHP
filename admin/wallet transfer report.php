...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="wallet transfer report.php" class="nav-item nav-link active"><i
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        &nbsp;
                                        <button class="btn btn-primary" id="datesearch">Go</button>&nbsp;&nbsp;&nbsp;
                                        <button class="btn btn-warning" type="button" id="dateclear">Clear</button>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-group mb-3 mt-auto">
                                        <input type="text" class="form-control" id="userid" style="max-width: 200px;"
                                            placeholder="User ID">
                                        <button class="btn btn-warning" type="button" id="idsearch">Search</button>
                                        &nbsp;&nbsp;&nbsp;
                                        <button class="btn btn-warning" type="button" id="idclear">Clear</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="./requiredFiles/js/wallettransferreport.js"></script>
