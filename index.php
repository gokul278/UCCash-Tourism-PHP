                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    ...
                                    <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">UCCASH TOURS & TRAVELS</h4>
                                    <h3 class="display-8 text-capitalize text-white mb-4">REACH YOUR DREAM DESTINATION EASY WITH US !</h3>
                                    <p class="mb-5 fs-5">Make use of our travel system and explore all your dream destinations without any worries.
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-2 px-4" href="services.php">Know More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="packages-carousel owl-carousel">
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/honeymoon package.jpg" class="img-fluid w-100 rounded-top" alt="honeymoon package">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt me-2"></i>7 DAYS / 6 NIGHTS</small>
                            </div>
                        </div>
                    ...
                    <div class="packages-item">
                        <div class="packages-img">
                            ...
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                                ...
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt me-2"></i>14 DAYS / 13 NIGHTS</small>
                        ...
                        <div class="packages-content bg-light">
                            <div style="text-align: center;" class="p-4 pb-0">
                                ...
                                <p class="mb-4">Spend your time with family and expolre various destination over the world.</p>
                            </div>
                            <div class="row bg-primary rounded-bottom mx-0">
                                <div class="col-6 text-start px-0">
                                    <a href="services.php" class="btn-hover btn text-white py-2 px-4">Read More</a>
                    ...
                    <div class="packages-item">
                        <div class="packages-img">
                            ...
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                                ...
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt me-2"></i>3 DAYS / 2 NIGHTS</small>
                        ...
                        <div class="packages-content bg-light">
                            <div style="text-align: center;" class="p-4 pb-0">
                                ...
                                <p class="mb-4">Specially organized for the customers who where obsessed with travelling.</p>
                            </div>
                            <div class="row bg-primary rounded-bottom mx-0">
                                <div class="col-6 text-start px-0">
                                    <a href="services.php" class="btn-hover btn text-white py-2 px-4">Read More</a>
                    ...
                    <div class="packages-item">
                        <div class="packages-img">
                            ...
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                                ...
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt me-2"></i>10 DAYS / 9 NIGHTS</small>
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div  class="service-content text-end">
                                        ...
                                        <p style="text-align: center;" >We provides best services in booking to your dream destinations at easy and budget friendly manner.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div  class="service-content text-end">
                                        ...
                                        <p style="text-align: center;" >With your travel booking we have our fun activites as a added one which makes your travel as memorable one.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div  class="service-content text-end">
                                        ...
                                        <p style="text-align: center;" >All our packages are planed with combaining unique places which were not bounded in any other packages.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div  class="service-content text-end">
                                        ...
                                        <p style="text-align: center;" >We have tie ups with popular hotels and bookes your stays which, makes your journey a comfortable one.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div  class="service-content text-end">
                                        ...
                                        <p style="text-align: center;" >Prior to your journey we plan and reserve all the mandatory bookings for sight seeings which makes you happy.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div  class="service-content text-end">
                                        ...
                                        <p style="text-align: center;" >We have tie ups with worlds leading travel advisors and make use of them in achiving top branding stage.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="adv_box">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p style="text-align: center;">Its advisable to carry copies of all mandatory documents in your journey.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="adv_box">
              <div class="media">
                <div class="media-body">
                  ...
                  <p style="text-align: center;">In-order to make your travel comfort, register with a trusted agent.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="adv_box">
              <div class="media">
                <div class="media-body">
                  ...
                  <p style="text-align: center;">Its advisable to carry local cash in your journey for emergency.</p>
                </div>
              </div>
            </div>
          </div>
